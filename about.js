...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Marcar ABOUT US / COMPANY como activo
  document.querySelectorAll('[data-page="about"]').forEach(a => {
    a.classList.add('active');
  });

  // Opcional: marcar también COMPANY como contexto activo
  document.querySelectorAll('[data-page="company"]').forEach(a => {
    a.classList.add('active');
  });

  // ===== ANIMACIONES SCROLL ABOUT =====
